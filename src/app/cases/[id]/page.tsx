            ...
            <div className="max-w-[1800px] mx-auto space-y-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        ...
                        <div className="bg-linear-to-br from-purple-50 to-blue-50 dark:from-purple-900/10 dark:to-blue-900/10 p-1 rounded-2xl border border-purple-100 dark:border-purple-900/30">
