...
// Fixed origin where Google OAuth is registered. Override via NEXT_PUBLIC_GOOGLE_AUTH_POPUP_ORIGIN.
const POPUP_ORIGIN = process.env.NEXT_PUBLIC_GOOGLE_AUTH_POPUP_ORIGIN ?? "http://localhost:3000";
