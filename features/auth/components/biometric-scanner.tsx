 ...
 * 
 * Simulates a Face ID scanning process with visual feedback.
 * - Starts in an "idle" state.
 * - Transitions to "scanning" after 500ms.
 * - Completes with "success" after 3.5 seconds.
 * 
 * Uses Framer Motion for the scanning animation and verified indicator.
 *
 * @returns A UI component displaying the scanning animation and status text.
 */
